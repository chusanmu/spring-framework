...
public class DefaultSingletonBeanRegistry extends SimpleAliasRegistry implements SingletonBeanRegistry {
	...
	public Object getSingleton(String beanName, ObjectFactory<?> singletonFactory) {
		...
		synchronized (this.singletonObjects) {
			...
			if (singletonObject == null) {
				...
				// TODO: 创建前置检查:1.若在inCreationCheckExclusions里校验名单里，是ok的
				// TODO: 2.singletonsCurrentlyInCreation把它添加进去，证明这个bean正在创建中
				...
				try {
					...
					// TODO: 再次判断，若有人已经把这个bean放进去了，那就抛个异常吧
					singletonObject = this.singletonObjects.get(beanName);
					if (singletonObject == null) {
						throw ex;
					}
					...
					// TODO: 处理异常，比如经常遇到的UnsatisfiedDependencyException异常，@Autowired的时候找不到依赖的bean就是这个异常，一般由NoSuchBeanDefinition这个异常导致
					// TODO: 这里会把异常拼接起来，然后一起打印出来
					if (recordSuppressedExceptions) {
	...
	public void registerDependentBean(String beanName, String dependentBeanName) {
		...
		// TODO: dependentBeanMap 来存放当前bean被引用的bean的集合
